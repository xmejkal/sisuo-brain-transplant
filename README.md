...
| Part | State |
| --- | --- |
| Firmware | Written, 63 tests passing, **simulated end to end** on a real MicroPython runtime and on a simulated ESP32-C6 in Wokwi |
...
python3 -m unittest discover -s tests -t tests   # 63 tests, ~1 s, no hardware
```
